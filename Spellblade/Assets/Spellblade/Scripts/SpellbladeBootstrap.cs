...
namespace Spellblade
{
    ...
    public class SpellbladeBootstrap : MonoBehaviour
    {
        ...
        /// <summary>
        /// The four disciplines + their primary spells, generated in code so
        /// nothing depends on .asset files. Numbers are the Phase 1 tuning pass —
        /// tweak freely (all fields public on SpellSO).
        /// </summary>
        private List<Discipline> CreateDisciplines()
        {
            ...
            {
                Discipline.Create("Umbra", umbralLance.themeColor, "Q", umbralLance),
                Discipline.Create("Frost", rimeblast.themeColor, "W", rimeblast),
                Discipline.Create("Storm", tempestBolt.themeColor, "E", tempestBolt),
                Discipline.Create("Blood", hemorrhage.themeColor, "R", hemorrhage),
            };
        }
    }
}
